		...
		<form class="form-horizontal" role="form" action="${adminPath}/message?method=save" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="${message.id}">
			 ...
			 <div class="form-group">
			 	...
			 	<div class="col-sm-5">
			 			<input type="text" class="form-control" id="auditType" name="auditType" placeholder="请输入审核状态" value="${message.auditType}">
		    	</div>
			 </div>
			 <div class="form-group">
			 	<label for="name" class="col-sm-3 control-label">回复内容</label>
			 	<div class="col-sm-5">
			 			<input type="text" class="form-control" id="replay" name="replay" placeholder="请输入回复内容" value="${message.replay}">
		    	</div>
			 </div>
			 <div class="form-group">
			 	<label for="name" class="col-sm-3 control-label">回复时间</label>
			 	<div class="col-sm-5">
			 			<input name="replayTime" type="text" readonly="readonly" maxlength="20" class="form-control Wdate"
					value="<fmt:formatDate value="${message.replayTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
		    	</div>
			 </div>
			 <div class="form-group">
			 	<label for="name" class="col-sm-3 control-label">回复人</label>
			 	<div class="col-sm-5">
			 			<input type="text" class="form-control" id="replayUser" name="replayUser" placeholder="请输入回复人" value="${message.replayUser}">
		    	</div>
			 </div>
